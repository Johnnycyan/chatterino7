...
public:
    ...
    virtual CustomBadgesController *getCustomBadges() = 0;
};
...
private:
    ...
    std::unique_ptr<CustomBadgesController> customBadges;
#ifdef CHATTERINO_HAVE_PLUGINS
...
public:
    ...
    CustomBadgesController *getCustomBadges() override;
